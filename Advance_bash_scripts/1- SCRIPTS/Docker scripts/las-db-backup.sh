...
CONFIGPATH="/opt/odoo/lastest11-odoo/conf/odoo.conf"
HOST="lastest11.sodexis.com"
DBNAME="LAS_Master"
NFS_MOUNT_BASE="/mnt/ftp-backup"
BACKUPDIR="${NFS_MOUNT_BASE}/lasiesta/Database"
...
VACUUMDB_LOG=$LOGDIR/$SCRIPT_NAME-VACUUMDB-`date +%m_%d-%H:%M:%S`.log     # vacuumdb log
#
