...
# Block sync, can permit 7 ip at max.
...
# Allow ssh
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 2298 -j ACCEPT
...
# Plesk autoinstaller port 
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 8447 -s 74.208.98.95 -j ACCEPT
$IPT -A INPUT -i ${PUB_IF} -p tcp -dport 8447 -j DROP

# Plesk ADminstrative interface (8443:https and 8880: http)
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 8443 -s 74.208.98.95 -j ACCEPT
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 8880 -s 74.208.98.95 -j ACCEPT
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 8443 -j DROP
$IPT -A INPUT -i ${PUB_IF} -p tcp --destination-port 8880 -j DROP
