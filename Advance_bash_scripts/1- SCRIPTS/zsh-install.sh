...
sudo apt-get install -y git gcc make autoconf yodl libncursesw5-dev texinfo checkinstall
...
#installing the oh-my-zsh
# exit and become root again to take zsh shell.
